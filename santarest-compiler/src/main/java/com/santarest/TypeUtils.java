...
public class TypeUtils {
    ...
    /**
     * if type is parameterized and one generic parameter contains "?", this will means that any type acceptable
     */
    ...
    public static Class<?> getElementClass(Element element) {
        try {
            return Class.forName(TypeName.get(element.asType()).toString().replaceAll("[<].*?[>]", ""));
