...
public final class RequestBuilder {
    ...
    private RestAction.Method requestMethod = RestAction.Method.GET;
    ...
    public void setRequestType(RestAction.Type type) {
        switch (type) {
    ...
    public void setMethod(RestAction.Method method) {
