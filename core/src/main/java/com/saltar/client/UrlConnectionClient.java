...
public class UrlConnectionClient implements HttpClient {
    ...
    Response readResponse(HttpURLConnection connection) throws IOException {
        ...
        ResponseBody responseBody = new ResponseBodyStream(mimeType, length, stream);
        return new Response(connection.getURL().toString(), status, reason, headers, responseBody);
    }

    private static class ResponseBodyStream implements ResponseBody {
        private final String mimeType;
        private final long length;
        private final InputStream stream;

        private ResponseBodyStream(String mimeType, long length, InputStream stream) {
