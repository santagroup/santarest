 ...
 */
package com.saltar.client;

import com.saltar.http.ByteArrayBody;
...
/**
 * A {@link com.saltar.client.HttpClient} which uses an implementation of Apache's {@link HttpClient}.
 */
public class ApacheClient implements com.saltar.client.HttpClient {
    ...
    static class TypedOutputEntity extends AbstractHttpEntity {
        ...
        TypedOutputEntity(RequestBody requestBody) {
